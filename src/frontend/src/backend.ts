...
export class Backend implements backendInterface {
    ...
    async getContact(arg0: bigint): Promise<EmergencyContact> {
        if (this.processError) {
            try {
    ...
    async listContacts(): Promise<Array<EmergencyContact>> {
        if (this.processError) {
            try {
    ...
    async updateContact(arg0: bigint, arg1: EmergencyContact): Promise<void> {
        if (this.processError) {
            try {
